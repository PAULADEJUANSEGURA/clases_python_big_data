...
def crear_csv(lista, nombre_fichero, carpeta):
    fichero = open(f"./{carpeta}/{nombre_fichero}", 'a', encoding='UTF-8', newline="")
    # saber las cabeceras
    cabeceras = []
    ...
    mi_csv.writeheader()
    # Escribir cada fila en el fichero.csv

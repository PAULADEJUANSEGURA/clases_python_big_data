...
def cargar_excel(carpeta, fichero):
    ...
    # Creamos una lista vacía para almacenar los datos de los clientes de telefonia
    lista_clientes_telefonia = []
    ...
    for fila in hoja.iter_rows(min_row=2, values_only=True):
        cliente_dict = dict(zip(cabeceras, fila))
        lista_clientes_telefonia.append(cliente_dict)
   
   
    return lista_clientes_telefonia

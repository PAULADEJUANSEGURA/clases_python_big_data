...
def imprimir_al_reves(texto):
    resultado = ""
    contador = len(texto) 
    for i in range(len(texto)):
        resultado = resultado + texto[contador - 1]
        contador = contador - 1
    print(resultado)

imprimir_al_reves(frase)

lista_palabras = frase.split()
def invertir_palabras(lista_palabras):
    resultado = ""
    for palabra in lista_palabras:
        resultado = resultado + palabra + " "
    print(resultado)
invertir_palabras(lista_palabras)
